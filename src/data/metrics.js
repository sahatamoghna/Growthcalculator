...
export const userMetrics = {
  Sam: {
    ...
    retailAcquisitionCredits:        2000,
    retailConversionCount:             8,
    retailConversionCredits:         2400,
    activeAmbassadorAcquisitionCount:  6,
    activeAmbassadorAcquisitionCredits:1200,
    activeAmbassadorConversionCount:   5,
    activeAmbassadorConversionCredits:1500,
    businessAcquisitionCount:          4,
    businessAcquisitionCredits:       8000,
  ...
  Rick: {
    ...
    retailAcquisitionCredits:        1400,
    retailConversionCount:             5,
    retailConversionCredits:         2000,
    activeAmbassadorAcquisitionCount:  4,
    activeAmbassadorAcquisitionCredits: 800,
    activeAmbassadorConversionCount:   3,
    activeAmbassadorConversionCredits: 900,
    businessAcquisitionCount:          2,
    businessAcquisitionCredits:       6000,
